(function bootstrapYouTubeDanmakuI18n(root, factory) {
  ...
  const TRANSLATIONS = Object.freeze({
    en: Object.freeze({
      ...
      cleanTimeParameter: 'Time links (beta)',
      cleanTimeParameterDescription: 'Removes t from the link and seeks to that point, preventing refreshes from returning to a fixed time.',
    ...
    zh: Object.freeze({
      ...
      cleanTimeParameter: '时间链接 (beta)',
      cleanTimeParameterDescription: '移除链接中的 t 参数并跳转到对应进度，避免刷新时返回固定时间点。',
      displayArea: '显示区域',
      opacity: '不透明度',
      fontSize: '弹幕字号',
      speed: '弹幕速度',
    ...
    ja: Object.freeze({
      ...
      cleanTimeParameter: '時間リンク (beta)',
      cleanTimeParameterDescription: 'リンクの t パラメータを削除して指定位置へ移動し、更新時に同じ時点へ戻るのを防ぎます。',
      displayArea: '表示範囲',
      opacity: '不透明度',
      fontSize: '文字サイズ',
      speed: '弾幕速度',
    ...
    ko: Object.freeze({
      ...
      cleanTimeParameter: '시간 링크 (beta)',
      cleanTimeParameterDescription: '링크의 t 매개변수를 제거하고 해당 지점으로 이동해, 새로고침 시 고정 시점으로 돌아가지 않게 합니다.',
      displayArea: '표시 영역',
      opacity: '불투명도',
      fontSize: '글자 크기',
      speed: '탄막 속도',
